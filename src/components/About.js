    ...
    return (
        <div id="about" className='about'>
            <div className='content'>
                ...
                <br></br>
                <p className='par-txt'>Prime’s team members are proven experts in player acquisition, data attribution and unique retention while executing a multi-brand strategy. The company is based in Cyprus, and supported by teams in Israel, The Philippines and Malta.</p>
